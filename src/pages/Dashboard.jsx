          ...
          <Card className="text-center py-12 bg-white/5 backdrop-blur-xl border-white/10">
            <CardContent>
              ...
              <h3 className="text-2xl font-semibold text-white mb-2">
                {searchTerm || categoryFilter !== 'all' ? 'No forms found' : 'No forms yet'}
              </h3>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <Link to={`/forms/${form._id}`}>
                          <Button variant="outline" size="sm" className="h-10 w-10 p-0 border-gray-600/50 bg-gray-800/30 backdrop-blur-sm text-gray-300 hover:bg-gray-700/50 hover:text-white">
                        ...
                        <Button variant="outline" size="sm" onClick={() => copyShareUrl(form._id)} className="h-10 w-10 p-0 border-gray-600/50 bg-gray-800/30 backdrop-blur-sm text-gray-300 hover:bg-gray-700/50 hover:text-white">
                          <Copy className="w-5 h-5" />
                        </Button>
                        <Button variant="outline" size="sm" onClick={() => deleteForm(form._id)} className="h-10 w-10 p-0 border-gray-600/50 bg-gray-800/30 backdrop-blur-sm text-gray-300 hover:bg-red-500/20 hover:text-red-400 hover:border-red-500/50">
